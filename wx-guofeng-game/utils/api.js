 ...
 */
function wxLogin(code, nickname, avatarUrl, platform) {
  return post('/api/user/wxLogin', { code, nickname, avatarUrl, platform: platform || 'wx' });
}
 ...
 * @param {string} [platform] - wx | tiktok | others
 */
function userInit(openid, nickname, platform) {
  return post('/api/user/init', { openid, nickname, platform: platform || 'wx' });
}
